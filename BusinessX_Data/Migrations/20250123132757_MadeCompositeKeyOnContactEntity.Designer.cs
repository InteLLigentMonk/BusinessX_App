...
namespace BusinessX_Data.Migrations
{
    ...
    [Migration("20250123132757_MadeCompositeKeyOnContactEntity")]
    partial class MadeCompositeKeyOnContactEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessX_Data.Entities.CustomerEntity", b =>
                {
                    ...
                    b.HasIndex("ContactId", "ContactFirstName", "ContactLastName");
            ...
            modelBuilder.Entity("BusinessX_Data.Entities.CustomerEntity", b =>
                {
                    b.HasOne("BusinessX_Data.Entities.ContactEntity", "Contact")
                        .WithMany("Customers")
                        .HasForeignKey("ContactId", "ContactFirstName", "ContactLastName");
